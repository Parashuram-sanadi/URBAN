...
export default function BankingAdmin() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      console.error("Bank operation failed:", err);
    ...
    <div className="dashboard">
      <div className="dashboard-header">
        <div className="header-center">
          <h1>Banking Admin</h1>
          <p>Add and manage bank details. Paste image URLs (comma-separated).</p>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="grid2">
            <div className="full">
              ...
              <input className="in" name="name" value={form.name} onChange={handleChange} placeholder="Bank Name" />
            </div>
            <div className="full">
            ...
            <div>
              <label>Timing</label>
              <input className="in" name="timing" value={form.timing} onChange={handleChange} placeholder="e.g. 9 AM - 5 PM" />
            </div>
          </div>
        </section>
      ...
      <div className="city-grid" style={{ marginTop: 24 }}>
        {items.map((item) => (
          <div key={item._id} className="city-card">
            ...
            {item.timing && <p>Timing: {item.timing}</p>}
      ...
      <footer>
        ...
        <button className="footer-btn" onClick={() => navigate("/feature/banking")}>View Public Page</button>
      </footer>
    </div>
  );
}
