...
export default function TemplesAdmin() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      console.error("Temple operation failed:", err);
    ...
    <div className="dashboard">
      <div className="dashboard-header">
        <div className="header-center">
          <h1>Temples Admin</h1>
          <p>Add and manage temple details. Paste image URLs (comma-separated).</p>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="grid2">
            <div>
              ...
              <input className="in" name="name" value={form.name} onChange={handleChange} placeholder="Temple Name" />
            </div>
            <div>
              <label>Deity</label>
              <input className="in" name="deity" value={form.deity} onChange={handleChange} placeholder="e.g. Lord Shiva" />
            </div>
            <div className="full">
            ...
            <div className="full">
              ...
              <input className="in" name="openingTime" value={form.openingTime} onChange={handleChange} placeholder="e.g. 6:00 AM - 9:00 PM" />
            </div>
            <div className="full">
      ...
      <div className="city-grid" style={{ marginTop: 24 }}>
        {items.map((item) => (
          <div key={item._id} className="city-card">
            ...
            {item.openingTime && <p><strong>Opening Time:</strong> {item.openingTime}</p>}
      ...
      <footer>
        ...
        <button className="footer-btn" onClick={() => navigate("/feature/utilities")}>View Public Page</button>
      </footer>
    </div>
  );
}
